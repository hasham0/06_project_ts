...
const Tec1 = new Teacher("ahsan", "khan", 34, "male", "MS", 5, 2034, "programming");
const Tec2 = new Teacher("zia", "khan", 35, "male", "MS", 20, 2334, "java programming");
const Tec3 = new Teacher("adil", "altaf", 28, "male", "MS", 8, 2064, "full stack developer");
...
async function teacherSignUp() {
    ...
    let { name, fatherName, age, gender, qualification, experiance, id, subject, } = teacherInfo;
    console.log("-----------------------------------");
    console.log("Teacher Information");
    const NewJoinTeacher = new Teacher(name, fatherName, age, gender, qualification, experiance, id, subject);
